...
def evaluate(model, dataloader, criterion, device, tgt_vocab, max_len):
    ...
    start_symbol = tgt_vocab.sos_idx  # Adjust this if needed
...
def train_model(epochs=10, max_len=100, tokenizer_type='simple', stepLR=False):
    wandb.init(dir='/scratch/hmnshpl/anlp_data/')
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep_config, project='ANLP_2nd_assignment_last')
